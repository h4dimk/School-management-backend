...
import { createLeave, findLeavebyTeacherId, removeLeave, updateLeaveStatus, findStudentsLeaves } from "./manageLeave";
...
export { findByEmail, getTeacherById, updateTeacher, getAnnouncements, createAttendence, getAttendance, createLeave, findLeavebyTeacherId, removeLeave, updateLeaveStatus, findStudentsLeaves, createMessage, findChats, findTimetables, findbyBatchMcqs, createMcq, findbyTeacherMcqs, findAssignmentbyBatchId, getBatches, createRemark, findRemarks, getBatchRanks };
