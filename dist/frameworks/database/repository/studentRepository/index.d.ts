...
import { findbyBatchMcqs, createMcqSubmit, findAnsweredMCQs } from "./manageMcqs";
import { createAssignment, findAssignmentbyStudentId } from "./manageAssignment";
...
export { findByEmail, getStudentById, updateStudent, getAnnouncements, createLeave, findLeavebyStudentId, removeLeave, createMessage, findChats, createGroup, findGroup, findTimetables, findbyBatchMcqs, createMcqSubmit, createAssignment, findAssignmentbyStudentId, findAnsweredMCQs, findRemarks, getAttendance, getBatchRanks };
